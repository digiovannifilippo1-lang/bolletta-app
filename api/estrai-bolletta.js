...
\f0\fs24 \cf0 // api/estrai-bolletta.js\
\
...
\
    // Vercel fornisce il body come stream; usiamo un buffer\
    const chunks = [];\
...
\
    // Inoltriamo il body cos\'ec com'\'e8 a OCR.Space\
...
\}\
\
// Copia la logica dalla tua parseInvoiceText del browser\
...
\
    const euroPatterns = [\
      /(?:totale|importo da pagare|importo)[\\s:]*\'80?\\s*(\\d\{1,5\}[\\.,]\\d\{2\})/i,\
